...
![image-20220722163435203](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220722163435203.png)

## 漏洞分析

从POC开始入手，跟进到ysoserial里的C3P0类的getObject方法

![image-20220725115141784](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725115141784.png)
...
![image-20220725131734036](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725131734036.png)
...
![image-20220725132430138](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725132430138.png)
...
![image-20220725132931945](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725132931945.png)

这里先从反序列化流里面读出来Object，就是ReferenceIndirector.ReferenceSerialized对象，这个类是实现了IndirectlySerialized接口的，所以会进入到这里的getObject方法里面去

![image-20220725140944895](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725140944895.png)

开始看到这里的lookup以为有可能JNDI注入，再看了看参数在序列化过程中不可控，但是可以跟进referenceToObject方法，这里传入了我们可控的reference对象

![image-20220725150254453](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220725150254453.png)
...
![image-20220726172030664](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726172030664.png)
...
![image-20220726203618799](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726203618799.png)
...
![image-20220726203713923](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726203713923.png)

接下来实例化beanClass，这里也就是为什么要一个无参的构造函数的原因，然后获取forceString属性的值，最后创建一个hashmap

![image-20220726203933358](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726203933358.png)

![image-20220726204027794](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726204027794.png)
...
![image-20220726204422294](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726204422294.png)

![image-20220726204243291](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726204243291.png)

通过上面迭代的操作，这里的ra变为了

![image-20220726204325226](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220726204325226.png)
...
![image-20220727142614226](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727142614226.png)
...
![image-20220727160629485](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727160629485.png)

但是我并没有找到setuserOverridesAstring方法，不过打断点进入了setUpPropertyListeners方法，看名字，应该是监听所以setter事件的函数的汇总，刚刚好这里的两个分支就是这个类的两个参数

而且获取了参数名和参数值

![image-20220727160819991](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727160819991.png)

跟进parseUserOverridesAsString方法

![image-20220727161009616](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727161009616.png)

这里有个substring操作，也就是为什么传入的userOverridesAsString的值是`HexAsciiSerializedMap:HexString`，截断后把hex转化成字节数组传入fromByteArray方法

继续跟进

![image-20220727161417163](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727161417163.png)

跟进deserializeFromByteArray

![image-20220727161457532](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727161457532.png)
...
![image-20220727162851476](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727162851476.png)

## 漏洞分析

先调用setJndiName设置对应参数，这里的jndiname这个参数在其父类JndiRefDataSourceBase里

![image-20220727165224938](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727165224938.png)

接下来调用setLoginTimeout

![image-20220727165343639](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727165343639.png)

跟进inner

![image-20220727165419176](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727165419176.png)

跟进dereference

![image-20220727165517962](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220727165517962.png)
