...
![image-20220331233411170](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220331233411170.png)

这里可以看到parse只调用了setter方法

![image-20220401000148794](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401000148794.png)
...
![image-20220401133755844](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401133755844.png)

还是走到了这里的deserialize

首先步入打这里的一个scanSymbol扫描到了第一个字段`_bytescodes`

![image-20220401134515300](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401134515300.png)

继续往下走，会创建一个实例

![image-20220401134706671](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401134706671.png)

可以看到这个实例是TemplatesImpl对象

接着往下，会走到这里调用parseFiled，此时的key是`_bytecodes`

![image-20220401134206809](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401134206809.png)

跟进parseFiled

这里只会去获取TemplatesImpl的_bytecodes字段对象，在下面这里会创建字段对象的反序列化器DefaultFieldDeserializer

![image-20220401135721972](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401135721972.png)

在这个方法的结尾调用DefaultFieldDeserializer的parseFiled方法对_bytecodes内容进行解析

![image-20220401135855453](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401135855453.png)

跟进`FieldDeserializer.parseField`,解析出`_bytecodes`对应的内容后，会调用setValue()函数设置对应的值，这里value即为恶意类二进制内容Base64编码后的数据

![image-20220401140256757](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401140256757.png)

继续跟进，在结尾处可以看到

![image-20220401140434283](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401140434283.png)
...
![image-20220401141127273](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401141127273.png)

接下来来到`templatesImpl.getOutputProperties`

![image-20220401140557920](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401140557920.png)
...
![image-20220401133312798](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401133312798.png)
...
![image-20220401193525345](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401193525345.png)
...
![image-20220401221941481](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401221941481.png)
...
![image-20220401234859760](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401234859760.png)
...
![image-20220401231230909](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401231230909.png)
...
![image-20220401235034215](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220401235034215.png)
...
![image-20220402001050801](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220402001050801.png)
