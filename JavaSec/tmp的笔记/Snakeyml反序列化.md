...
![image-20220728155741400](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220728155741400.png)
...
![image-20220729210143501](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729210143501.png)
...
![image-20220729102519554](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729102519554.png)

然后起一个web服务

![image-20220729102324024](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729102324024.png)
...
![image-20220729172155642](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729172155642.png)

![image-20220729172207399](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729172207399.png)

![image-20220729182324597](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729182324597.png)
...
![image-20220729200611833](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729200611833.png)

StreamReader类其实就是个赋值，没必要看，跟进loadFromReader

![image-20220729200837375](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729200837375.png)
...
![image-20220729201036824](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220729201036824.png)

可以看到`!!`标识已经变成了`tag:yaml.arg.2022:`,在网上也有师傅提到过在`!!`被过滤的情况下可以用这种tag标识来绕过（https://b1ue.cn/archives/407.html）

接下来跟进constructDocument方法

![image-20220731210147648](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220731210147648.png)
...
![image-20220801093054984](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801093054984.png)

这里的判断为false，所以进入constructObjectNoCheck方法

![image-20220801143541934](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801143541934.png)
...
![image-20220801155338465](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801155338465.png)

node一直是刚才处理后的node，跟进getConstructor

![image-20220801155420446](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801155420446.png)

跟进getClassForNode

![image-20220801155731875](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801155731875.png)

这里获取node中的tag的类名

![image-20220801155810202](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801155810202.png)
...
![image-20220801160509904](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801160509904.png)

![image-20220801174914451](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801174914451.png)

把这个tag和获取到的类放到了应该hashmap里面去，然后返回获取到的类

![image-20220801180943259](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801180943259.png)

会设置这个node的Type为这个类，然后就往上返回

![image-20220801175918310](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801175918310.png)

刚才进的getConstructor，现在继续往后看constructor方法，进来后向下步进走else分支

![image-20220801180040687](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801180040687.png)

前面有一句`SequenceNode snode = (SequenceNode)node;`，就把node的类型转化一下，值还是一样的，因为只有一个value，所以size为1，这里相当于n`ew ArrayList(1)`，往下就获取一个构造器，因为刚才设置了type为获取到的javax.script.ScriptEngineManager类，所以获取它的所有构造方法放到`arr$`数组里

然后通过for循环`arr$`添加到之前创造的数组possibleConstructors里面去，这里value只有一个，size为1，所以只有有一个参数的构造函数的length满足，这里两个构造函数只有第二个添加进去了

继续往下步进

![image-20220801185347301](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801185347301.png)
...
![image-20220801191559373](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801191559373.png)
...
![image-20220801192303986](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801192303986.png)

跟进init

![image-20220801192346076](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801192346076.png)

跟进initEngines

![image-20220801193921650](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801193921650.png)

![image-20220801193941775](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801193941775.png)

![image-20220801194349878](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801194349878.png)
...
![image-20220801194125603](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801194125603.png)
...
![image-20220801194837397](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801194837397.png)
...
![image-20220801195603437](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801195603437.png)

第一次实例化的是NashornScriptEngineFactory，第二次才是POC类

![image-20220801195815350](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801195815350.png)

最后实例化POC类加载恶意代码

这里才是真的去找META-INF/services/javax.script.ScriptEngineFactory的信息判断返回，如果没有则会返回false，有的话会去获取到里面的信息放到nextName里面

![image-20220801200244961](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801200244961.png)

然后在第二次进入next的时候走到nextService的时候获取类名然后实例化

![image-20220801200435920](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801200435920.png)
...
![image-20220801200707937](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801200707937.png)
...
![image-20220801202836322](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801202836322.png)
...
![image-20220801205539420](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220801205539420.png)
...
![image-20220802090730130](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220802090730130.png)
...
![image-20220802095619441](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220802095619441.png)
...
![image-20220802095907733](C:\Users\ga't'c\AppData\Roaming\Typora\typora-user-images\image-20220802095907733.png)
